...
The lesson is divided into three different parts:
 ...
 - **Part III - zfit Advanced** shows examples on more advanced use cases for `zfit`, like performing pseudoexperiments, statistical background subtraction, simultanous fits, fits to a disjointed observable space and showing pull plots.
